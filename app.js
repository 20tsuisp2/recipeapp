...
const starterRecipes = {
  quick: [
    {
      id: 'q1', title: 'Chicken Parmesan',
      desc: 'Breaded chicken, tomato sauce, melted mozzarella.',
      ...
      instructions: [
        ...
        'Beat the egg in a shallow bowl. Coat each chicken breast in egg, then press into breadcrumbs.',
        'Fry in olive oil over medium heat, 3-4 minutes per side until golden.',
        'Transfer to a baking dish, top with tomato sauce and both cheeses.',
        'Bake for 15 minutes until the cheese is bubbling and golden.'
      ],
      macros: { calories: 620, protein: 48, carbs: 38, fat: 30 },
      notes: 'Great with a side salad or spaghetti.'
    },
    {
      id: 'q2', title: 'Zucchini Frittata',
      desc: 'Eggs, zucchini, cheese — pan to oven in 15 minutes.',
      prepTime: 10, cookTime: 15, servings: 2,
      ingredients: [
        { name: 'eggs', amount: 6, unit: '' },
        { name: 'zucchini, sliced', amount: 200, unit: 'g' },
        { name: 'parmesan, grated', amount: 30, unit: 'g' },
        { name: 'olive oil', amount: 15, unit: 'ml' },
        { name: 'salt', amount: 2, unit: 'g' }
      ],
      instructions: [
        'Whisk the eggs with the parmesan and salt.',
        'Heat oil in an oven-safe pan, cook zucchini for 5 minutes until soft.',
        'Pour in the eggs, cook on low for 5 minutes until mostly set.',
        'Finish under the grill for 3-4 minutes until golden on top.'
      ],
      macros: { calories: 340, protein: 24, carbs: 6, fat: 24 },
      notes: 'Good hot or cold, keeps well for lunch the next day.'
    },
    {
      id: 'q3', title: 'Baked Salmon with Tomatoes & Zucchini',
      desc: 'One tray, 20 minutes, hard to overcook.',
      ...
      instructions: [
        'Preheat oven to 200°C.',
        'Place salmon, tomatoes and zucchini on a tray. Drizzle with oil, scatter over crushed garlic.',
        'Bake for 18-20 minutes until the salmon flakes easily.'
      ],
      macros: { calories: 410, protein: 38, carbs: 9, fat: 25 },
      notes: 'Serve with rice or crusty bread.'
    }
  ],
  prep: [
    {
      id: 'p1', title: 'Beef Ragù',
      desc: 'Slow-simmered beef and tomato sauce, freezes well.',
      prepTime: 15, cookTime: 90, servings: 4,
      ingredients: [
        { name: 'beef mince', amount: 500, unit: 'g' },
        { name: 'onion, diced', amount: 1, unit: '' },
        { name: 'carrot, diced', amount: 1, unit: '' },
        { name: 'celery stick, diced', amount: 1, unit: '' },
        { name: 'tomato passata', amount: 700, unit: 'ml' },
        { name: 'olive oil', amount: 20, unit: 'ml' },
        { name: 'garlic cloves', amount: 2, unit: '' }
      ],
      instructions: [
        'Heat oil in a large pot, soften onion, carrot and celery for 5 minutes.',
        'Add beef mince, cook until browned.',
        'Stir in garlic and passata, season.',
        'Simmer on low for 1.5 hours, stirring occasionally.'
      ],
      macros: { calories: 390, protein: 32, carbs: 14, fat: 22 },
      notes: 'Freezes well in portions for up to 3 months.'
    },
    {
      id: 'p2', title: 'Meatballs in Tomato Sauce',
      desc: 'Big batch, great over pasta or on its own.',
      ...
      instructions: [
        'Mix beef, breadcrumbs, egg and parmesan. Roll into balls.',
        'Fry meatballs in a splash of oil until browned all over.',
        'Add passata and garlic, cover and simmer for 20 minutes.'
      ],
      macros: { calories: 410, protein: 34, carbs: 16, fat: 23 },
      notes: 'Serve over pasta or with crusty bread.'
    }
  ],
  baking: [
    {
      id: 'b1', title: 'Basic Pancakes',
      desc: 'Four ingredients, ready in 10 minutes.',
      prepTime: 5, cookTime: 10, servings: 2,
      ingredients: [
        { name: 'flour', amount: 120, unit: 'g' },
        { name: 'milk', amount: 180, unit: 'ml' },
        { name: 'egg', amount: 1, unit: '' },
        { name: 'butter, melted', amount: 15, unit: 'g' }
      ],
      instructions: [
        'Whisk flour, milk and egg into a smooth batter.',
        'Stir in melted butter.',
        'Cook spoonfuls in a hot non-stick pan, 2 minutes per side.'
      ],
      macros: { calories: 320, protein: 12, carbs: 44, fat: 10 },
      notes: 'Top with fruit or honey.'
    },
    {
      id: 'b2', title: 'One-Bowl Vanilla Cake',
      desc: 'Mix, pour, bake — no mixer needed.',
      prepTime: 10, cookTime: 35, servings: 8,
      ingredients: [
        { name: 'flour', amount: 250, unit: 'g' },
        { name: 'sugar', amount: 200, unit: 'g' },
        { name: 'butter, softened', amount: 150, unit: 'g' },
      ...
      instructions: [
        ...
        'Fold in flour and baking powder, then milk.',
        'Pour into the tin and bake for 30-35 minutes until a skewer comes out clean.'
      ],
      macros: { calories: 310, protein: 5, carbs: 42, fat: 14 },
      notes: 'Keeps for 3 days in an airtight container.'
    }
  ]
};
...
let state = { section: 'quick', view: 'list', openId: null, multiplier: 1 };
...
function renderList(app) {
  ...
  app.innerHTML = `<div class="section-tabs">${tabs}</div><div id="cards">${cards || '<p class="empty">No recipes here yet.</p>'}</div>`;
